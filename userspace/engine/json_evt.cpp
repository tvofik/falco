...
k8s_audit_filter_check::k8s_audit_filter_check()
{
...

	{
		...
		m_aliases = {
			...
			{"ka.req.volume.any_hostpath", {"/requestObject/spec/volumes"_json_pointer, check_hostpath_vols, a::IDX_REQUIRED, a::IDX_KEY}},
			{"ka.req.volume.all_hostpath", {"/requestObject/spec/volumes"_json_pointer, check_hostpath_vols, a::IDX_REQUIRED, a::IDX_KEY}},
			{"ka.req.volume.hostpath", {"/requestObject/spec/volumes"_json_pointer, check_hostpath_vols, a::IDX_REQUIRED, a::IDX_KEY}},
			{"ka.req.volume_types.within", {"/requestObject/spec/volumes"_json_pointer, check_volume_types, a::IDX_REQUIRED, a::IDX_KEY}},
